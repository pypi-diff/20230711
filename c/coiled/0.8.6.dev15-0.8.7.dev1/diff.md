# Comparing `tmp/coiled-0.8.6.dev15.tar.gz` & `tmp/coiled-0.8.7.dev1.tar.gz`

## Comparing `coiled-0.8.6.dev15.tar` & `coiled-0.8.7.dev1.tar`
...
### Comparing `coiled-0.8.6.dev15/coiled/__init__.py` & `coiled-0.8.7.dev1/coiled/__init__.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/analytics.py` & `coiled-0.8.7.dev1/coiled/analytics.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/auth.py` & `coiled-0.8.7.dev1/coiled/auth.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cluster.py` & `coiled-0.8.7.dev1/coiled/cluster.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/coiled.yaml` & `coiled-0.8.7.dev1/coiled/coiled.yaml`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/context.py` & `coiled-0.8.7.dev1/coiled/context.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/core.py` & `coiled-0.8.7.dev1/coiled/core.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/exceptions.py` & `coiled-0.8.7.dev1/coiled/exceptions.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/magic.py` & `coiled-0.8.7.dev1/coiled/magic.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/run.py` & `coiled-0.8.7.dev1/coiled/run.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/scan.py` & `coiled-0.8.7.dev1/coiled/scan.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/shutdown.py` & `coiled-0.8.7.dev1/coiled/shutdown.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/software.py` & `coiled-0.8.7.dev1/coiled/software.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/types.py` & `coiled-0.8.7.dev1/coiled/types.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/utils.py` & `coiled-0.8.7.dev1/coiled/utils.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/websockets.py` & `coiled-0.8.7.dev1/coiled/websockets.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/config.py` & `coiled-0.8.7.dev1/coiled/cli/config.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/core.py` & `coiled-0.8.7.dev1/coiled/cli/core.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/curl.py` & `coiled-0.8.7.dev1/coiled/cli/curl.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/env.py` & `coiled-0.8.7.dev1/coiled/cli/env.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/login.py` & `coiled-0.8.7.dev1/coiled/cli/login.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/package_sync.py` & `coiled-0.8.7.dev1/coiled/cli/package_sync.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/prefect.py` & `coiled-0.8.7.dev1/coiled/cli/prefect.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/run.py` & `coiled-0.8.7.dev1/coiled/cli/run.py`
...
### Comparing `coiled-0.8.6.dev15/coiled/cli/utils.py` & `coiled-0.8.7.dev1/coiled/cli/utils.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/cluster/__init__.py` & `coiled-0.8.7.dev1/coiled/cli/cluster/__init__.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/cluster/better_logs.py` & `coiled-0.8.7.dev1/coiled/cli/cluster/better_logs.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/cluster/logs.py` & `coiled-0.8.7.dev1/coiled/cli/cluster/logs.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/cluster/metrics.py` & `coiled-0.8.7.dev1/coiled/cli/cluster/metrics.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/cluster/ssh.py` & `coiled-0.8.7.dev1/coiled/cli/cluster/ssh.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/cluster/utils.py` & `coiled-0.8.7.dev1/coiled/cli/cluster/utils.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/notebook/__init__.py` & `coiled-0.8.7.dev1/coiled/cli/notebook/__init__.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/notebook/notebook.py` & `coiled-0.8.7.dev1/coiled/cli/notebook/notebook.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/setup/__init__.py` & `coiled-0.8.7.dev1/coiled/cli/setup/__init__.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/setup/amp.py` & `coiled-0.8.7.dev1/coiled/cli/setup/amp.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/setup/aws.py` & `coiled-0.8.7.dev1/coiled/cli/setup/aws.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/setup/entry.py` & `coiled-0.8.7.dev1/coiled/cli/setup/entry.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/setup/gcp.py` & `coiled-0.8.7.dev1/coiled/cli/setup/gcp.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/cli/setup/prometheus.py` & `coiled-0.8.7.dev1/coiled/cli/setup/prometheus.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/extensions/prefect/runners.py` & `coiled-0.8.7.dev1/coiled/extensions/prefect/runners.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/extensions/prefect/workers.py` & `coiled-0.8.7.dev1/coiled/extensions/prefect/workers.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/__init__.py` & `coiled-0.8.7.dev1/coiled/v2/__init__.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/cluster.py` & `coiled-0.8.7.dev1/coiled/v2/cluster.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/core.py` & `coiled-0.8.7.dev1/coiled/v2/core.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/cwi_log_link.py` & `coiled-0.8.7.dev1/coiled/v2/cwi_log_link.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/states.py` & `coiled-0.8.7.dev1/coiled/v2/states.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/widgets/__init__.py` & `coiled-0.8.7.dev1/coiled/v2/widgets/__init__.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/widgets/rich.py` & `coiled-0.8.7.dev1/coiled/v2/widgets/rich.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/coiled/v2/widgets/util.py` & `coiled-0.8.7.dev1/coiled/v2/widgets/util.py`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/LICENSE` & `coiled-0.8.7.dev1/LICENSE`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/README.md` & `coiled-0.8.7.dev1/README.md`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/pyproject.toml` & `coiled-0.8.7.dev1/pyproject.toml`

 * *Files identical despite different names*

### Comparing `coiled-0.8.6.dev15/PKG-INFO` & `coiled-0.8.7.dev1/PKG-INFO`
