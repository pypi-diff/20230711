# Comparing `tmp/caqui-1.15.0.tar.gz` & `tmp/caqui-1.9.0.tar.gz`

## Comparing `caqui-1.15.0.tar` & `caqui-1.9.0.tar`

### file list

```diff
@@ -1,39 +1,34 @@
--rw-r--r--   0        0        0     3207 2020-02-02 00:00:00.000000 caqui-1.15.0/CODE_OF_CONDUCT.md
--rw-r--r--   0        0        0      462 2020-02-02 00:00:00.000000 caqui-1.15.0/CONTRIBUTING.md
--rw-r--r--   0        0        0    11307 2020-02-02 00:00:00.000000 caqui-1.15.0/sample-appium.py
--rw-r--r--   0        0        0      875 2020-02-02 00:00:00.000000 caqui-1.15.0/sample-win-app-driver.py
--rw-r--r--   0        0        0      823 2020-02-02 00:00:00.000000 caqui-1.15.0/sample-winium.py
--rw-r--r--   0        0        0     2267 2020-02-02 00:00:00.000000 caqui-1.15.0/sample.py
--rw-r--r--   0        0        0       43 2020-02-02 00:00:00.000000 caqui-1.15.0/test-requirements.txt
--rw-r--r--   0        0        0      396 2020-02-02 00:00:00.000000 caqui-1.15.0/tox.ini
--rw-r--r--   0        0        0      834 2020-02-02 00:00:00.000000 caqui-1.15.0/.github/ISSUE_TEMPLATE/bug_report.md
--rw-r--r--   0        0        0      126 2020-02-02 00:00:00.000000 caqui-1.15.0/.github/ISSUE_TEMPLATE/custom.md
--rw-r--r--   0        0        0      595 2020-02-02 00:00:00.000000 caqui-1.15.0/.github/ISSUE_TEMPLATE/feature_request.md
--rw-r--r--   0        0        0     1357 2020-02-02 00:00:00.000000 caqui-1.15.0/.github/workflows/python-app.yml
--rw-r--r--   0        0        0     1084 2020-02-02 00:00:00.000000 caqui-1.15.0/.github/workflows/python-publish.yml
--rw-r--r--   0        0        0      331 2020-02-02 00:00:00.000000 caqui-1.15.0/.vscode/settings.json
--rw-r--r--   0        0        0    43559 2020-02-02 00:00:00.000000 caqui-1.15.0/caqui/__init__.py
--rw-r--r--   0        0        0    20338 2020-02-02 00:00:00.000000 caqui-1.15.0/caqui/asynchronous.py
--rw-r--r--   0        0        0      169 2020-02-02 00:00:00.000000 caqui-1.15.0/caqui/constants.py
--rw-r--r--   0        0        0       42 2020-02-02 00:00:00.000000 caqui-1.15.0/caqui/exceptions.py
--rw-r--r--   0        0        0      508 2020-02-02 00:00:00.000000 caqui-1.15.0/caqui/helper.py
--rw-r--r--   0        0        0    19857 2020-02-02 00:00:00.000000 caqui-1.15.0/caqui/synchronous.py
--rw-r--r--   0        0        0        0 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/__init__.py
--rw-r--r--   0        0        0      164 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/constants.py
--rw-r--r--   0        0        0     6832 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/fake_responses.py
--rw-r--r--   0        0        0     4210 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/test_sniffer.py
--rw-r--r--   0        0        0  5466526 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/apk/app-debug.apk
--rw-r--r--   0        0        0    18928 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/feature/test_sync_and_async.py
--rw-r--r--   0        0        0     2281 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/html/playground.html
--rw-r--r--   0        0        0     1167 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/integration/test_async_scenarios.py
--rw-r--r--   0        0        0     2459 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/integration/test_sync_scenarios.py
--rw-r--r--   0        0        0        0 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/unit/__initi__.py
--rw-r--r--   0        0        0     9679 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/unit/test_async_unit.py
--rw-r--r--   0        0        0     1556 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/unit/test_helper.py
--rw-r--r--   0        0        0     6522 2020-02-02 00:00:00.000000 caqui-1.15.0/tests/unit/test_sync_unit.py
--rwxr-xr-x   0        0        0       77 2020-02-02 00:00:00.000000 caqui-1.15.0/utils/coverage.sh
--rw-r--r--   0        0        0     3084 2020-02-02 00:00:00.000000 caqui-1.15.0/.gitignore
--rw-r--r--   0        0        0     1072 2020-02-02 00:00:00.000000 caqui-1.15.0/LICENSE
--rw-r--r--   0        0        0    10530 2020-02-02 00:00:00.000000 caqui-1.15.0/README.md
--rw-r--r--   0        0        0      768 2020-02-02 00:00:00.000000 caqui-1.15.0/pyproject.toml
--rw-r--r--   0        0        0    11131 2020-02-02 00:00:00.000000 caqui-1.15.0/PKG-INFO
...
### Comparing `caqui-1.15.0/CODE_OF_CONDUCT.md` & `caqui-1.9.0/CODE_OF_CONDUCT.md`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/sample.py` & `caqui-1.9.0/sample.py`
...
### Comparing `caqui-1.15.0/.github/ISSUE_TEMPLATE/bug_report.md` & `caqui-1.9.0/.github/ISSUE_TEMPLATE/bug_report.md`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/.github/ISSUE_TEMPLATE/feature_request.md` & `caqui-1.9.0/.github/ISSUE_TEMPLATE/feature_request.md`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/.github/workflows/python-app.yml` & `caqui-1.9.0/.github/workflows/python-app.yml`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/.github/workflows/python-publish.yml` & `caqui-1.9.0/.github/workflows/python-publish.yml`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/caqui/__init__.py` & `caqui-1.9.0/caqui/__init__.py`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/tests/fake_responses.py` & `caqui-1.9.0/tests/fake_responses.py`
...
### Comparing `caqui-1.15.0/tests/test_sniffer.py` & `caqui-1.9.0/tests/test_sniffer.py`
...
### Comparing `caqui-1.15.0/tests/integration/test_async_scenarios.py` & `caqui-1.9.0/tests/integration/test_async_scenarios.py`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/tests/integration/test_sync_scenarios.py` & `caqui-1.9.0/tests/integration/test_sync_scenarios.py`
...
### Comparing `caqui-1.15.0/tests/unit/test_async_unit.py` & `caqui-1.9.0/tests/unit/test_async_unit.py`
...
### Comparing `caqui-1.15.0/tests/unit/test_helper.py` & `caqui-1.9.0/tests/unit/test_helper.py`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/tests/unit/test_sync_unit.py` & `caqui-1.9.0/tests/unit/test_sync_unit.py`
...
### Comparing `caqui-1.15.0/.gitignore` & `caqui-1.9.0/.gitignore`
...
### Comparing `caqui-1.15.0/LICENSE` & `caqui-1.9.0/LICENSE`

 * *Files identical despite different names*

### Comparing `caqui-1.15.0/README.md` & `caqui-1.9.0/PKG-INFO`
...
### Comparing `caqui-1.15.0/pyproject.toml` & `caqui-1.9.0/pyproject.toml`
...
### Comparing `caqui-1.15.0/PKG-INFO` & `caqui-1.9.0/README.md`
...
```diff
@@ -1,45 +1,29 @@
-Metadata-Version: 2.1 Name: caqui Version: 1.15.0 Summary: Run asynchronous
-commands in WebDrivers Project-URL: Homepage, https://github.com/douglasdcm/
-caqui Project-URL: Bug Tracker, https://github.com/douglasdcm/caqui/issues
-Author-email: Douglas Cardoso
-noemail.com> License-File: LICENSE Classifier: Development Status :: 4 - Beta
