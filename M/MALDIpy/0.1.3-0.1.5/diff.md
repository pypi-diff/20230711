# Comparing `tmp/MALDIpy-0.1.3.tar.gz` & `tmp/MALDIpy-0.1.5.tar.gz`
...
+gzip compressed data, was "MALDIpy-0.1.5.tar", last modified: Mon Jul 10 22:21:42 2023, max compression
```

## Comparing `MALDIpy-0.1.3.tar` & `MALDIpy-0.1.5.tar`
...
+drwxr-xr-x   0 hli       (1002) labmem    (1001)        0 2023-07-10 22:21:42.479148 MALDIpy-0.1.5/
+-rw-r--r--   0 hli       (1002) labmem    (1001)     1062 2023-04-04 21:12:06.000000 MALDIpy-0.1.5/LICENSE
+drwxr-xr-x   0 hli       (1002) labmem    (1001)        0 2023-07-10 22:21:42.475149 MALDIpy-0.1.5/MALDIpy/
+-rw-r--r--   0 hli       (1002) labmem    (1001)      187 2023-07-10 22:21:19.000000 MALDIpy-0.1.5/MALDIpy/__init__.py
+-rw-r--r--   0 hli       (1002) labmem    (1001)     7607 2023-06-12 22:20:09.000000 MALDIpy-0.1.5/MALDIpy/featureplot.py
+-rw-r--r--   0 hli       (1002) labmem    (1001)     6599 2023-04-06 16:02:36.000000 MALDIpy-0.1.5/MALDIpy/msi_data.py
+-rw-r--r--   0 hli       (1002) labmem    (1001)     3084 2023-04-06 18:34:41.000000 MALDIpy-0.1.5/MALDIpy/multi_sample.py
+-rw-r--r--   0 hli       (1002) labmem    (1001)     8183 2023-07-10 22:19:52.000000 MALDIpy-0.1.5/MALDIpy/projection.py
+drwxr-xr-x   0 hli       (1002) labmem    (1001)        0 2023-07-10 22:21:42.479148 MALDIpy-0.1.5/MALDIpy/shell/
+-rw-r--r--   0 hli       (1002) labmem    (1001)       61 2023-04-04 21:15:37.000000 MALDIpy-0.1.5/MALDIpy/shell/__init__.py
+-rw-r--r--   0 hli       (1002) labmem    (1001)      196 2023-04-04 21:15:37.000000 MALDIpy-0.1.5/MALDIpy/shell/usage.py
+-rw-r--r--   0 hli       (1002) labmem    (1001)     1690 2023-04-06 13:55:22.000000 MALDIpy-0.1.5/MALDIpy/single_cell.py
+drwxr-xr-x   0 hli       (1002) labmem    (1001)        0 2023-07-10 22:21:42.479148 MALDIpy-0.1.5/MALDIpy/src/
+-rw-r--r--   0 hli       (1002) labmem    (1001)        0 2023-04-04 21:12:06.000000 MALDIpy-0.1.5/MALDIpy/src/temp.txt
+drwxr-xr-x   0 hli       (1002) labmem    (1001)        0 2023-07-10 22:21:42.479148 MALDIpy-0.1.5/MALDIpy.egg-info/
+-rw-r--r--   0 hli       (1002) labmem    (1001)      855 2023-07-10 22:21:42.000000 MALDIpy-0.1.5/MALDIpy.egg-info/PKG-INFO
+-rw-r--r--   0 hli       (1002) labmem    (1001)      441 2023-07-10 22:21:42.000000 MALDIpy-0.1.5/MALDIpy.egg-info/SOURCES.txt
+-rw-r--r--   0 hli       (1002) labmem    (1001)        1 2023-07-10 22:21:42.000000 MALDIpy-0.1.5/MALDIpy.egg-info/dependency_links.txt
+-rw-r--r--   0 hli       (1002) labmem    (1001)       47 2023-07-10 22:21:42.000000 MALDIpy-0.1.5/MALDIpy.egg-info/entry_points.txt
+-rw-r--r--   0 hli       (1002) labmem    (1001)        8 2023-07-10 22:21:42.000000 MALDIpy-0.1.5/MALDIpy.egg-info/top_level.txt
+-rw-r--r--   0 hli       (1002) labmem    (1001)        1 2023-04-04 21:25:43.000000 MALDIpy-0.1.5/MALDIpy.egg-info/zip-safe
+-rw-r--r--   0 hli       (1002) labmem    (1001)      176 2023-04-04 21:15:37.000000 MALDIpy-0.1.5/MANIFEST.in
+-rw-r--r--   0 hli       (1002) labmem    (1001)      855 2023-07-10 22:21:42.479148 MALDIpy-0.1.5/PKG-INFO
+-rw-r--r--   0 hli       (1002) labmem    (1001)      328 2023-07-10 22:21:36.000000 MALDIpy-0.1.5/README.md
+-rw-r--r--   0 hli       (1002) labmem    (1001)        0 2023-04-04 21:12:06.000000 MALDIpy-0.1.5/requirements.txt
+-rw-r--r--   0 hli       (1002) labmem    (1001)       38 2023-07-10 22:21:42.479148 MALDIpy-0.1.5/setup.cfg
+-rw-r--r--   0 hli       (1002) labmem    (1001)     1989 2023-07-10 22:14:10.000000 MALDIpy-0.1.5/setup.py
```

### Comparing `MALDIpy-0.1.3/LICENSE` & `MALDIpy-0.1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `MALDIpy-0.1.3/MALDIpy/featureplot.py` & `MALDIpy-0.1.5/MALDIpy/featureplot.py`

 * *Files identical despite different names*

### Comparing `MALDIpy-0.1.3/MALDIpy/msi_data.py` & `MALDIpy-0.1.5/MALDIpy/msi_data.py`

 * *Files identical despite different names*

### Comparing `MALDIpy-0.1.3/MALDIpy/multi_sample.py` & `MALDIpy-0.1.5/MALDIpy/multi_sample.py`

 * *Files identical despite different names*

### Comparing `MALDIpy-0.1.3/MALDIpy/projection.py` & `MALDIpy-0.1.5/MALDIpy/projection.py`
...
### Comparing `MALDIpy-0.1.3/MALDIpy/single_cell.py` & `MALDIpy-0.1.5/MALDIpy/single_cell.py`

 * *Files identical despite different names*

### Comparing `MALDIpy-0.1.3/setup.py` & `MALDIpy-0.1.5/setup.py`
