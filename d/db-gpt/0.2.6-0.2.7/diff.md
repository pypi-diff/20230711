# Comparing `tmp/db-gpt-0.2.6.tar.gz` & `tmp/db-gpt-0.2.7.tar.gz`
...
### Comparing `db-gpt-0.2.6/DB_GPT.egg-info/SOURCES.txt` & `db-gpt-0.2.7/DB_GPT.egg-info/SOURCES.txt`
...
### Comparing `db-gpt-0.2.6/pilot/configs/config.py` & `db-gpt-0.2.7/pilot/configs/config.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/configs/model_config.py` & `db-gpt-0.2.7/pilot/configs/model_config.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/conversation.py` & `db-gpt-0.2.7/pilot/conversation.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/EncodeTextLoader.py` & `db-gpt-0.2.7/pilot/embedding_engine/EncodeTextLoader.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/chn_document_splitter.py` & `db-gpt-0.2.7/pilot/embedding_engine/chn_document_splitter.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/csv_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/csv_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/embedding_engine.py` & `db-gpt-0.2.7/pilot/embedding_engine/embedding_engine.py`
...
### Comparing `db-gpt-0.2.6/pilot/embedding_engine/knowledge_type.py` & `db-gpt-0.2.7/pilot/embedding_engine/knowledge_type.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/markdown_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/markdown_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/pdf_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/pdf_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/pdf_loader.py` & `db-gpt-0.2.7/pilot/embedding_engine/pdf_loader.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/ppt_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/ppt_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/search_milvus.py` & `db-gpt-0.2.7/pilot/embedding_engine/search_milvus.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/source_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/source_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/string_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/string_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/url_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/url_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/embedding_engine/word_embedding.py` & `db-gpt-0.2.7/pilot/embedding_engine/word_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/inference_parsers/base.py` & `db-gpt-0.2.7/pilot/inference_parsers/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/json_utils/json_fix_general.py` & `db-gpt-0.2.7/pilot/json_utils/json_fix_general.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/json_utils/utilities.py` & `db-gpt-0.2.7/pilot/json_utils/utilities.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/log/json_handler.py` & `db-gpt-0.2.7/pilot/log/json_handler.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/logs.py` & `db-gpt-0.2.7/pilot/logs.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/memory/chat_history/base.py` & `db-gpt-0.2.7/pilot/memory/chat_history/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/memory/chat_history/duckdb_history.py` & `db-gpt-0.2.7/pilot/memory/chat_history/duckdb_history.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/memory/chat_history/file_history.py` & `db-gpt-0.2.7/pilot/memory/chat_history/file_history.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/memory/chat_history/mem_history.py` & `db-gpt-0.2.7/pilot/memory/chat_history/mem_history.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/adapter.py` & `db-gpt-0.2.7/pilot/model/adapter.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/cache/base.py` & `db-gpt-0.2.7/pilot/model/cache/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/cache/disk_cache.py` & `db-gpt-0.2.7/pilot/model/cache/disk_cache.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/cache/gpt_cache.py` & `db-gpt-0.2.7/pilot/model/cache/gpt_cache.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/cache/memory_cache.py` & `db-gpt-0.2.7/pilot/model/cache/memory_cache.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/compression.py` & `db-gpt-0.2.7/pilot/model/compression.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/chatglm_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/chatglm_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/falcon_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/falcon_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/gorilla_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/gorilla_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/gpt4all_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/gpt4all_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/guanaco_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/guanaco_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/proxy_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/proxy_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/vicuna_base_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/vicuna_base_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_out/vicuna_llm.py` & `db-gpt-0.2.7/pilot/model/llm_out/vicuna_llm.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/llm_utils.py` & `db-gpt-0.2.7/pilot/model/llm_utils.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/model/loader.py` & `db-gpt-0.2.7/pilot/model/loader.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/openapi/api_v1/api_v1.py` & `db-gpt-0.2.7/pilot/openapi/api_v1/api_v1.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/openapi/api_v1/api_view_model.py` & `db-gpt-0.2.7/pilot/openapi/api_v1/api_view_model.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/out_parser/base.py` & `db-gpt-0.2.7/pilot/out_parser/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/prompts/base.py` & `db-gpt-0.2.7/pilot/prompts/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/prompts/example_base.py` & `db-gpt-0.2.7/pilot/prompts/example_base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/prompts/generator.py` & `db-gpt-0.2.7/pilot/prompts/generator.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/prompts/prompt_new.py` & `db-gpt-0.2.7/pilot/prompts/prompt_new.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/prompts/prompt_template.py` & `db-gpt-0.2.7/pilot/prompts/prompt_template.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/base.py` & `db-gpt-0.2.7/pilot/scene/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/base_chat.py` & `db-gpt-0.2.7/pilot/scene/base_chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/base_message.py` & `db-gpt-0.2.7/pilot/scene/base_message.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_dashboard/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_dashboard/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_dashboard/data_preparation/report_schma.py` & `db-gpt-0.2.7/pilot/scene/chat_dashboard/data_preparation/report_schma.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_dashboard/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_dashboard/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_dashboard/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_dashboard/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/auto_execute/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_db/auto_execute/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/auto_execute/example.py` & `db-gpt-0.2.7/pilot/scene/chat_db/auto_execute/example.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/auto_execute/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_db/auto_execute/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/auto_execute/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_db/auto_execute/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/professional_qa/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_db/professional_qa/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/professional_qa/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_db/professional_qa/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_db/professional_qa/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_db/professional_qa/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_execution/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_execution/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_execution/example.py` & `db-gpt-0.2.7/pilot/scene/chat_execution/example.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_execution/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_execution/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_execution/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_execution/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_factory.py` & `db-gpt-0.2.7/pilot/scene/chat_factory.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/custom/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/custom/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/custom/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/custom/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/custom/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/custom/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/default/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/default/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/default/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/default/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/default/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/default/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/inner_db_summary/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/inner_db_summary/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/inner_db_summary/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/inner_db_summary/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/inner_db_summary/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/inner_db_summary/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/url/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/url/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/url/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/url/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/url/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/url/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/v1/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/v1/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/v1/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/v1/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_knowledge/v1/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_knowledge/v1/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_normal/chat.py` & `db-gpt-0.2.7/pilot/scene/chat_normal/chat.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_normal/out_parser.py` & `db-gpt-0.2.7/pilot/scene/chat_normal/out_parser.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/chat_normal/prompt.py` & `db-gpt-0.2.7/pilot/scene/chat_normal/prompt.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/scene/message.py` & `db-gpt-0.2.7/pilot/scene/message.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/chat_adapter.py` & `db-gpt-0.2.7/pilot/server/chat_adapter.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/dbgpt_server.py` & `db-gpt-0.2.7/pilot/server/dbgpt_server.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/gradio_css.py` & `db-gpt-0.2.7/pilot/server/gradio_css.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/gradio_patch.py` & `db-gpt-0.2.7/pilot/server/gradio_patch.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/api.py` & `db-gpt-0.2.7/pilot/server/knowledge/api.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/chunk_db.py` & `db-gpt-0.2.7/pilot/server/knowledge/chunk_db.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/document_db.py` & `db-gpt-0.2.7/pilot/server/knowledge/document_db.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/request/request.py` & `db-gpt-0.2.7/pilot/server/knowledge/request/request.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/request/response.py` & `db-gpt-0.2.7/pilot/server/knowledge/request/response.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/service.py` & `db-gpt-0.2.7/pilot/server/knowledge/service.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/knowledge/space_db.py` & `db-gpt-0.2.7/pilot/server/knowledge/space_db.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/llmserver.py` & `db-gpt-0.2.7/pilot/server/llmserver.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/vectordb_qa.py` & `db-gpt-0.2.7/pilot/server/vectordb_qa.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/webserver.py` & `db-gpt-0.2.7/pilot/server/webserver.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/server/webserver_base.py` & `db-gpt-0.2.7/pilot/server/webserver_base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/singleton.py` & `db-gpt-0.2.7/pilot/singleton.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/speech/base.py` & `db-gpt-0.2.7/pilot/speech/base.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/speech/brian.py` & `db-gpt-0.2.7/pilot/speech/brian.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/speech/eleven_labs.py` & `db-gpt-0.2.7/pilot/speech/eleven_labs.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/speech/macos_tts.py` & `db-gpt-0.2.7/pilot/speech/macos_tts.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/speech/say.py` & `db-gpt-0.2.7/pilot/speech/say.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/summary/db_summary.py` & `db-gpt-0.2.7/pilot/summary/db_summary.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/summary/db_summary_client.py` & `db-gpt-0.2.7/pilot/summary/db_summary_client.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/summary/mysql_db_summary.py` & `db-gpt-0.2.7/pilot/summary/mysql_db_summary.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/utils.py` & `db-gpt-0.2.7/pilot/utils.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/vector_store/chroma_store.py` & `db-gpt-0.2.7/pilot/vector_store/chroma_store.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/vector_store/connector.py` & `db-gpt-0.2.7/pilot/vector_store/connector.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/vector_store/extract_tovec.py` & `db-gpt-0.2.7/pilot/vector_store/extract_tovec.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/vector_store/file_loader.py` & `db-gpt-0.2.7/pilot/vector_store/file_loader.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/vector_store/milvus_store.py` & `db-gpt-0.2.7/pilot/vector_store/milvus_store.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/pilot/vector_store/weaviate_store.py` & `db-gpt-0.2.7/pilot/vector_store/weaviate_store.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/setup.py` & `db-gpt-0.2.7/setup.py`
...
### Comparing `db-gpt-0.2.6/tests/unit/embedding_engine/test_url_embedding.py` & `db-gpt-0.2.7/tests/unit/embedding_engine/test_url_embedding.py`

 * *Files identical despite different names*

### Comparing `db-gpt-0.2.6/tests/unit/test_plugins.py` & `db-gpt-0.2.7/tests/unit/test_plugins.py`
