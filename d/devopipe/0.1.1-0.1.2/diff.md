# Comparing `tmp/devopipe-0.1.1.tar.gz` & `tmp/devopipe-0.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "devopipe-0.1.1.tar", max compression
+gzip compressed data, was "devopipe-0.1.2.tar", max compression
```

## Comparing `devopipe-0.1.1.tar` & `devopipe-0.1.2.tar`

### file list

```diff
@@ -1,6 +1,34 @@
--rw-r--r--   0        0        0        0 2023-03-23 09:26:05.749327 devopipe-0.1.1/README.md
--rw-r--r--   0        0        0        0 2023-03-23 09:26:05.749327 devopipe-0.1.1/devopipe/__init__.py
--rwxr-xr-x   0        0        0     1341 2023-03-23 08:04:24.655745 devopipe-0.1.1/devopipe/src/__pycache__/main.cpython-311.pyc
--rwxr-xr-x   0        0        0      467 2023-03-21 11:58:46.074853 devopipe-0.1.1/devopipe/src/main.py
--rw-r--r--   0        0        0      450 2023-03-23 09:26:15.269327 devopipe-0.1.1/pyproject.toml
--rw-r--r--   0        0        0      350 1970-01-01 00:00:00.000000 devopipe-0.1.1/PKG-INFO
