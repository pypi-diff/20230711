# Comparing `tmp/opendatablend-1.3.0.tar.gz` & `tmp/opendatablend-1.3.0rc1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "opendatablend-1.3.0.tar", last modified: Tue Jul 11 00:32:38 2023, max compression
+gzip compressed data, was "opendatablend-1.3.0rc1.tar", last modified: Mon Jul 10 23:45:55 2023, max compression
```

## Comparing `opendatablend-1.3.0.tar` & `opendatablend-1.3.0rc1.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxrwxrwx   0        0        0        0 2023-07-11 00:32:38.630072 opendatablend-1.3.0/
--rw-rw-rw-   0        0        0     1110 2021-07-06 22:59:46.000000 opendatablend-1.3.0/LICENSE
--rw-rw-rw-   0        0        0    15313 2023-07-11 00:32:38.632068 opendatablend-1.3.0/PKG-INFO
--rw-rw-rw-   0        0        0    14731 2023-07-10 23:05:48.000000 opendatablend-1.3.0/README.md
--rw-rw-rw-   0        0        0      108 2021-07-06 22:59:46.000000 opendatablend-1.3.0/pyproject.toml
--rw-rw-rw-   0        0        0      861 2023-07-11 00:32:38.641068 opendatablend-1.3.0/setup.cfg
-drwxrwxrwx   0        0        0        0 2023-07-11 00:32:38.455981 opendatablend-1.3.0/src/
-drwxrwxrwx   0        0        0        0 2023-07-11 00:32:38.519521 opendatablend-1.3.0/src/opendatablend/
--rw-rw-rw-   0        0        0       64 2023-07-10 19:43:55.000000 opendatablend-1.3.0/src/opendatablend/__init__.py
--rw-rw-rw-   0        0        0    17475 2023-07-10 23:31:38.000000 opendatablend-1.3.0/src/opendatablend/opendatablend.py
-drwxrwxrwx   0        0        0        0 2023-07-11 00:32:38.626073 opendatablend-1.3.0/src/opendatablend.egg-info/
--rw-rw-rw-   0        0        0    15313 2023-07-11 00:32:38.000000 opendatablend-1.3.0/src/opendatablend.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      311 2023-07-11 00:32:38.000000 opendatablend-1.3.0/src/opendatablend.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-07-11 00:32:38.000000 opendatablend-1.3.0/src/opendatablend.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0      107 2023-07-11 00:32:38.000000 opendatablend-1.3.0/src/opendatablend.egg-info/requires.txt
--rw-rw-rw-   0        0        0       14 2023-07-11 00:32:38.000000 opendatablend-1.3.0/src/opendatablend.egg-info/top_level.txt
...
### Comparing `opendatablend-1.3.0/LICENSE` & `opendatablend-1.3.0rc1/LICENSE`

 * *Files identical despite different names*

### Comparing `opendatablend-1.3.0/PKG-INFO` & `opendatablend-1.3.0rc1/PKG-INFO`
...
### Comparing `opendatablend-1.3.0/README.md` & `opendatablend-1.3.0rc1/README.md`

 * *Files identical despite different names*

### Comparing `opendatablend-1.3.0/setup.cfg` & `opendatablend-1.3.0rc1/setup.cfg`
...
-00000030: 300d 0a61 7574 686f 7220 3d20 4f70 656e  0..author = Open
...
### Comparing `opendatablend-1.3.0/src/opendatablend/opendatablend.py` & `opendatablend-1.3.0rc1/src/opendatablend/opendatablend.py`

 * *Files identical despite different names*

### Comparing `opendatablend-1.3.0/src/opendatablend.egg-info/PKG-INFO` & `opendatablend-1.3.0rc1/src/opendatablend.egg-info/PKG-INFO`
