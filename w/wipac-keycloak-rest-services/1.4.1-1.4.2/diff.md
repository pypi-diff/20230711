# Comparing `tmp/wipac-keycloak-rest-services-1.4.1.tar.gz` & `tmp/wipac-keycloak-rest-services-1.4.2.tar.gz`
...
### Comparing `wipac-keycloak-rest-services-1.4.1/LICENSE` & `wipac-keycloak-rest-services-1.4.2/LICENSE`
