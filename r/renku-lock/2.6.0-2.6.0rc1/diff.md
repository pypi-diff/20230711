# Comparing `tmp/renku_lock-2.6.0-py3-none-any.whl.zip` & `tmp/renku_lock-2.6.0rc1-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,6 +1,6 @@
-Zip file size: 3297 bytes, number of entries: 4
--rw-r--r--  2.0 unx       22 b- defN 80-Jan-01 00:00 renku_lock/__init__.py
--rw-r--r--  2.0 unx    11305 b- defN 80-Jan-01 00:00 renku_lock-2.6.0.dist-info/METADATA
--rw-r--r--  2.0 unx       88 b- defN 80-Jan-01 00:00 renku_lock-2.6.0.dist-info/WHEEL
-?rw-r--r--  2.0 unx      293 b- defN 16-Jan-01 00:00 renku_lock-2.6.0.dist-info/RECORD
-4 files, 11708 bytes uncompressed, 2727 bytes compressed:  76.7%
...
-Filename: renku_lock-2.6.0.dist-info/METADATA
+Filename: renku_lock-2.6.0rc1.dist-info/METADATA
 Comment: 
 
-Filename: renku_lock-2.6.0.dist-info/WHEEL
+Filename: renku_lock-2.6.0rc1.dist-info/WHEEL
 Comment: 
 
-Filename: renku_lock-2.6.0.dist-info/RECORD
...
## Comparing `renku_lock-2.6.0.dist-info/METADATA` & `renku_lock-2.6.0rc1.dist-info/METADATA`
