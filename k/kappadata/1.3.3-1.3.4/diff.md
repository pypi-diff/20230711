# Comparing `tmp/kappadata-1.3.3.tar.gz` & `tmp/kappadata-1.3.4.tar.gz`
...
### Comparing `kappadata-1.3.3/kappadata/transforms/base/kd_random_apply_base.py` & `kappadata-1.3.4/kappadata/transforms/base/kd_random_apply_base.py`
...
### Comparing `kappadata-1.3.3/kappadata/visualization/visualize_jigsaw.py` & `kappadata-1.3.4/kappadata/visualization/visualize_jigsaw.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/visualization/visualize_mae_schematic.py` & `kappadata-1.3.4/kappadata/visualization/visualize_mae_schematic.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/visualization/visualize_masked_image.py` & `kappadata-1.3.4/kappadata/visualization/visualize_masked_image.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/visualization/visualize_transform.py` & `kappadata-1.3.4/kappadata/visualization/visualize_transform.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/visualization/visualize_two_random_crop.py` & `kappadata-1.3.4/kappadata/visualization/visualize_two_random_crop.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/class_filter_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/class_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/dataset_wrappers/subset_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/mode_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/mode_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py` & `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata/wrappers/torch_wrapper.py` & `kappadata-1.3.4/kappadata/wrappers/torch_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/kappadata.egg-info/PKG-INFO` & `kappadata-1.3.4/kappadata.egg-info/PKG-INFO`
...
### Comparing `kappadata-1.3.3/kappadata.egg-info/SOURCES.txt` & `kappadata-1.3.4/kappadata.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.3/setup.cfg` & `kappadata-1.3.4/setup.cfg`
...
### Comparing `kappadata-1.3.3/test_unit_long/test_stochastic_transform_seed.py` & `kappadata-1.3.4/test_unit_long/test_stochastic_transform_seed.py`
...
### Comparing `kappadata-1.3.3/tests_external_sources/dinov2.py` & `kappadata-1.3.4/tests_external_sources/dinov2.py`
