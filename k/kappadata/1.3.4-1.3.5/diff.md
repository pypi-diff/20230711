# Comparing `tmp/kappadata-1.3.4.tar.gz` & `tmp/kappadata-1.3.5.tar.gz`
...
### Comparing `kappadata-1.3.4/kappadata/transforms/patchify_image.py` & `kappadata-1.3.5/kappadata/transforms/patchify_image.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/transforms/patchwise_norm.py` & `kappadata-1.3.5/kappadata/transforms/patchwise_norm.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/transforms/patchwise_random_rotation.py` & `kappadata-1.3.5/kappadata/transforms/patchwise_random_rotation.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/transforms/semseg/kd_semseg_pad.py` & `kappadata-1.3.5/kappadata/transforms/semseg/kd_semseg_pad.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/transforms/semseg/kd_semseg_random_crop.py` & `kappadata-1.3.5/kappadata/transforms/semseg/kd_semseg_random_crop.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/transforms/semseg/kd_semseg_random_resize.py` & `kappadata-1.3.5/kappadata/transforms/semseg/kd_semseg_random_resize.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/transforms/semseg/kd_semseg_resize.py` & `kappadata-1.3.5/kappadata/transforms/semseg/kd_semseg_resize.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/bounding_box_utils.py` & `kappadata-1.3.5/kappadata/utils/bounding_box_utils.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/class_counts.py` & `kappadata-1.3.5/kappadata/utils/class_counts.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/color_histogram.py` & `kappadata-1.3.5/kappadata/utils/color_histogram.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/hash_utils.py` & `kappadata-1.3.5/kappadata/utils/hash_utils.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/magnitude_sampler.py` & `kappadata-1.3.5/kappadata/utils/magnitude_sampler.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/multi_crop_utils.py` & `kappadata-1.3.5/kappadata/utils/multi_crop_utils.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/pos_embed.py` & `kappadata-1.3.5/kappadata/utils/pos_embed.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/random.py` & `kappadata-1.3.5/kappadata/utils/random.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/save_image.py` & `kappadata-1.3.5/kappadata/utils/save_image.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/utils/transform_utils.py` & `kappadata-1.3.5/kappadata/utils/transform_utils.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_dataset_imgsize.py` & `kappadata-1.3.5/kappadata/visualization/visualize_dataset_imgsize.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_interpolation.py` & `kappadata-1.3.5/kappadata/visualization/visualize_interpolation.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_jigsaw.py` & `kappadata-1.3.5/kappadata/visualization/visualize_jigsaw.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_mae_schematic.py` & `kappadata-1.3.5/kappadata/visualization/visualize_mae_schematic.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_masked_image.py` & `kappadata-1.3.5/kappadata/visualization/visualize_masked_image.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_transform.py` & `kappadata-1.3.5/kappadata/visualization/visualize_transform.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/visualization/visualize_two_random_crop.py` & `kappadata-1.3.5/kappadata/visualization/visualize_two_random_crop.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/class_filter_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/class_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/dataset_wrappers/subset_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/dataset_wrappers/subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/mode_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/mode_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py` & `kappadata-1.3.5/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata/wrappers/torch_wrapper.py` & `kappadata-1.3.5/kappadata/wrappers/torch_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/kappadata.egg-info/PKG-INFO` & `kappadata-1.3.5/kappadata.egg-info/PKG-INFO`
...
### Comparing `kappadata-1.3.4/kappadata.egg-info/SOURCES.txt` & `kappadata-1.3.5/kappadata.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/setup.cfg` & `kappadata-1.3.5/setup.cfg`
...
### Comparing `kappadata-1.3.4/test_unit_long/test_stochastic_transform_seed.py` & `kappadata-1.3.5/test_unit_long/test_stochastic_transform_seed.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.4/tests_external_sources/dinov2.py` & `kappadata-1.3.5/tests_external_sources/dinov2.py`
