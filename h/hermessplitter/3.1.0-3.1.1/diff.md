# Comparing `tmp/hermessplitter-3.1.0-py3-none-any.whl.zip` & `tmp/hermessplitter-3.1.1-py3-none-any.whl.zip`
...
-        self.make_log_hermes_db(weight)
...
## Comparing `hermessplitter-3.1.0.dist-info/LICENSE` & `hermessplitter-3.1.1.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `hermessplitter-3.1.0.dist-info/METADATA` & `hermessplitter-3.1.1.dist-info/METADATA`
...
## Comparing `hermessplitter-3.1.0.dist-info/RECORD` & `hermessplitter-3.1.1.dist-info/RECORD`
