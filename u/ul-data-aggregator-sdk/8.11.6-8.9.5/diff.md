# Comparing `tmp/ul-data-aggregator-sdk-8.11.6.tar.gz` & `tmp/ul-data-aggregator-sdk-8.9.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ul-data-aggregator-sdk-8.11.6.tar", last modified: Mon Jul 10 22:38:21 2023, max compression
+gzip compressed data, was "ul-data-aggregator-sdk-8.9.5.tar", last modified: Thu Jun 22 13:30:39 2023, max compression
```

## Comparing `ul-data-aggregator-sdk-8.11.6.tar` & `ul-data-aggregator-sdk-8.9.5.tar`

### file list

```diff
@@ -1,47 +1,47 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.492735 ul-data-aggregator-sdk-8.11.6/
--rw-r--r--   0 root         (0) root         (0)     1604 2023-07-10 22:38:21.492735 ul-data-aggregator-sdk-8.11.6/PKG-INFO
--rw-rw-rw-   0 root         (0) root         (0)     1038 2022-01-14 08:29:36.000000 ul-data-aggregator-sdk-8.11.6/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.488734 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/
--rw-rw-rw-   0 root         (0) root         (0)      540 2023-03-16 11:00:25.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.488734 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/__tests__/
--rw-rw-rw-   0 root         (0) root         (0)        0 2023-03-16 11:00:25.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/__tests__/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)     1161 2023-04-20 13:55:49.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/__tests__/test_integration_message.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.488734 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/brokers/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/brokers/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      270 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/brokers/data_aggregator_input_broker.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.488734 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      297 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/annotations.py
--rw-rw-rw-   0 root         (0) root         (0)     3777 2023-03-29 07:59:52.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/clock_timezones.py
--rw-rw-rw-   0 root         (0) root         (0)    17477 2023-07-07 02:26:24.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/enums.py
--rw-rw-rw-   0 root         (0) root         (0)       38 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/names.py
--rw-rw-rw-   0 root         (0) root         (0)      675 2022-08-05 17:06:54.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/dag.yml
--rw-rw-rw-   0 root         (0) root         (0)    72822 2023-07-10 22:34:41.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/data_aggregator_api_sdk.py
--rw-rw-rw-   0 root         (0) root         (0)      182 2023-06-28 08:33:52.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/data_aggregator_api_sdk_config.py
--rw-rw-rw-   0 root         (0) root         (0)      826 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/data_aggregator_sdk.py
--rw-rw-rw-   0 root         (0) root         (0)       95 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/data_aggregator_sdk_config.py
--rw-rw-rw-   0 root         (0) root         (0)      991 2022-08-17 11:37:58.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/errors.py
--rw-rw-rw-   0 root         (0) root         (0)    28951 2023-07-10 07:26:07.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/integration_message.py
--rw-rw-rw-   0 root         (0) root         (0)      158 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/lib.py
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-25 12:50:15.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/py.typed
--rw-rw-rw-   0 root         (0) root         (0)      152 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/runtime_conf.py
--rw-rw-rw-   0 root         (0) root         (0)      169 2022-08-03 16:22:45.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/self_logging.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.488734 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/types/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-10-03 10:34:42.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/types/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)     3200 2023-06-28 08:33:52.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/types/device.py
--rw-rw-rw-   0 root         (0) root         (0)     3401 2023-06-28 08:33:52.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/types/get_data_gateway_network_device_list.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.488734 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      257 2022-07-04 09:50:04.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/devices_info_box_to_json.py
--rw-rw-rw-   0 root         (0) root         (0)     1335 2023-06-28 08:33:52.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/internal_api_error_handler.py
--rw-rw-rw-   0 root         (0) root         (0)     1426 2023-06-28 08:33:52.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/internal_api_error_handler_old.py
--rw-rw-rw-   0 root         (0) root         (0)      685 2022-08-03 16:22:45.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/query_params.py
--rw-rw-rw-   0 root         (0) root         (0)      305 2023-05-04 12:01:39.000000 ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/round_dt.py
--rw-r--r--   0 root         (0) root         (0)       38 2023-07-10 22:38:21.492735 ul-data-aggregator-sdk-8.11.6/setup.cfg
--rw-rw-rw-   0 root         (0) root         (0)     1464 2023-07-10 22:36:48.000000 ul-data-aggregator-sdk-8.11.6/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-10 22:38:21.492735 ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/
--rw-r--r--   0 root         (0) root         (0)     1604 2023-07-10 22:38:21.000000 ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)     1544 2023-07-10 22:38:21.000000 ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-07-10 22:38:21.000000 ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       95 2023-07-10 22:38:21.000000 ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       20 2023-07-10 22:38:21.000000 ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/top_level.txt
...
### Comparing `ul-data-aggregator-sdk-8.11.6/PKG-INFO` & `ul-data-aggregator-sdk-8.9.5/PKG-INFO`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/README.md` & `ul-data-aggregator-sdk-8.9.5/README.md`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/__init__.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/__init__.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/__tests__/test_integration_message.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/__tests__/test_integration_message.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/clock_timezones.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/constants/clock_timezones.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/constants/enums.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/constants/enums.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/dag.yml` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/dag.yml`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/data_aggregator_sdk.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/data_aggregator_sdk.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/errors.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/errors.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/integration_message.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/integration_message.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/types/device.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/types/device.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/types/get_data_gateway_network_device_list.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/types/get_data_gateway_network_device_list.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/internal_api_error_handler.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/utils/internal_api_error_handler.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/internal_api_error_handler_old.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/utils/internal_api_error_handler_old.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/data_aggregator_sdk/utils/query_params.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/utils/query_params.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.6/setup.py` & `ul-data-aggregator-sdk-8.9.5/setup.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/PKG-INFO` & `ul-data-aggregator-sdk-8.9.5/ul_data_aggregator_sdk.egg-info/PKG-INFO`
...
### Comparing `ul-data-aggregator-sdk-8.11.6/ul_data_aggregator_sdk.egg-info/SOURCES.txt` & `ul-data-aggregator-sdk-8.9.5/ul_data_aggregator_sdk.egg-info/SOURCES.txt`
