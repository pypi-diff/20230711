# Comparing `tmp/lktbotfb-0.3.1.tar.gz` & `tmp/lktbotfb-0.3.2.tar.gz`
...
## Comparing `lktbotfb-0.3.1.tar` & `lktbotfb-0.3.2.tar`
...
### Comparing `lktbotfb-0.3.1/LICENSE` & `lktbotfb-0.3.2/LICENSE`

 * *Files identical despite different names*

### Comparing `lktbotfb-0.3.1/PKG-INFO` & `lktbotfb-0.3.2/PKG-INFO`
...
### Comparing `lktbotfb-0.3.1/setup.py` & `lktbotfb-0.3.2/setup.py`
...
### Comparing `lktbotfb-0.3.1/src/botfb/mylib.py` & `lktbotfb-0.3.2/src/botfb/mylib.py`
...
### Comparing `lktbotfb-0.3.1/src/lktbotfb.egg-info/PKG-INFO` & `lktbotfb-0.3.2/src/lktbotfb.egg-info/PKG-INFO`
