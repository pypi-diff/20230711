# Comparing `tmp/tencentcloud-sdk-python-emr-3.0.931.tar.gz` & `tmp/tencentcloud-sdk-python-emr-3.0.932.tar.gz`
...
## Comparing `tencentcloud-sdk-python-emr-3.0.931.tar` & `tencentcloud-sdk-python-emr-3.0.932.tar`
...
### Comparing `tencentcloud-sdk-python-emr-3.0.931/setup.py` & `tencentcloud-sdk-python-emr-3.0.932/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-emr-3.0.931/PKG-INFO` & `tencentcloud-sdk-python-emr-3.0.932/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-emr-3.0.931/README.rst` & `tencentcloud-sdk-python-emr-3.0.932/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-emr-3.0.931/tencentcloud_sdk_python_emr.egg-info/PKG-INFO` & `tencentcloud-sdk-python-emr-3.0.932/tencentcloud_sdk_python_emr.egg-info/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-emr-3.0.931/tencentcloud/emr/v20190103/errorcodes.py` & `tencentcloud-sdk-python-emr-3.0.932/tencentcloud/emr/v20190103/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-emr-3.0.931/tencentcloud/emr/v20190103/models.py` & `tencentcloud-sdk-python-emr-3.0.932/tencentcloud/emr/v20190103/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-emr-3.0.931/tencentcloud/emr/v20190103/emr_client.py` & `tencentcloud-sdk-python-emr-3.0.932/tencentcloud/emr/v20190103/emr_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-emr-3.0.931/tencentcloud/__init__.py` & `tencentcloud-sdk-python-emr-3.0.932/tencentcloud/__init__.py`
