# Comparing `tmp/task2b-1.0.7.tar.gz` & `tmp/task2b-1.0.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "task2b-1.0.7.tar", max compression
+gzip compressed data, was "task2b-1.0.8.tar", max compression
```

## Comparing `task2b-1.0.7.tar` & `task2b-1.0.8.tar`

### file list

```diff
@@ -1,16 +1,16 @@
--rw-r--r--   0        0        0      466 2023-07-08 14:31:48.331141 task2b-1.0.7/LICENSE
--rw-r--r--   0        0        0      321 2023-07-08 15:34:54.474410 task2b-1.0.7/pwgen2/__init__.py
--rw-r--r--   0        0        0      113 2023-07-08 15:34:54.488388 task2b-1.0.7/pwgen2/__main__.py
--rw-r--r--   0        0        0       23 2023-07-10 21:35:45.571454 task2b-1.0.7/pwgen2/__version__.py
--rw-r--r--   0        0        0       74 2023-07-08 15:35:37.625438 task2b-1.0.7/pwgen2/cli/__init__.py
--rw-r--r--   0        0        0      113 2023-07-08 15:35:37.612436 task2b-1.0.7/pwgen2/cli/__main__.py
--rw-r--r--   0        0        0     4664 2023-07-10 15:53:00.202469 task2b-1.0.7/pwgen2/cli/cli.py
--rw-r--r--   0        0        0    10100 2023-07-10 20:52:19.816687 task2b-1.0.7/pwgen2/pwgen2.py
--rw-r--r--   0        0        0       94 2023-07-08 15:35:37.620439 task2b-1.0.7/pwgen2/showcase/__init__.py
--rw-r--r--   0        0        0      133 2023-07-08 15:35:37.616441 task2b-1.0.7/pwgen2/showcase/__main__.py
--rw-r--r--   0        0        0      132 2023-07-10 16:39:29.431805 task2b-1.0.7/pwgen2/showcase/pattern-list-error.txt
--rw-r--r--   0        0        0      276 2023-07-10 21:35:29.827459 task2b-1.0.7/pwgen2/showcase/pattern-list.txt
--rw-r--r--   0        0        0    23207 2023-07-10 21:35:29.822465 task2b-1.0.7/pwgen2/showcase/showcase.py
--rw-r--r--   0        0        0      587 2023-07-10 21:35:45.575456 task2b-1.0.7/pyproject.toml
--rw-r--r--   0        0        0    17418 2023-07-10 20:13:20.833667 task2b-1.0.7/README.md
--rw-r--r--   0        0        0    17813 1970-01-01 00:00:00.000000 task2b-1.0.7/PKG-INFO
...
### Comparing `task2b-1.0.7/pwgen2/cli/cli.py` & `task2b-1.0.8/pwgen2/cli/cli.py`

 * *Files identical despite different names*

### Comparing `task2b-1.0.7/pwgen2/pwgen2.py` & `task2b-1.0.8/pwgen2/pwgen2.py`

 * *Files identical despite different names*

### Comparing `task2b-1.0.7/pwgen2/showcase/showcase.py` & `task2b-1.0.8/pwgen2/showcase/showcase.py`
...
-                'command': 'echo u{{4}}[Ld^l^\\4^\\5^\\6^\\7^\\8]{{3}}l{{2}} | pwgen2 -c6 {} | sort -r',
-                'module_command': f'echo u{{{{4}}}}[Ld^l^\\4^\\5^\\6^\\7^\\8]{{{{3}}}}l{{{{2}}}} | {python_command} pwgen2 -c6 {{}} | sort -r',
+                'command': 'echo "u{{4}}[Ld^l^\\4^\\5^\\6^\\7^\\8]{{3}}l{{2}}" | pwgen2 -c6 {} | sort -r',
+                'module_command': f'echo "u{{{{4}}}}[Ld^l^\\4^\\5^\\6^\\7^\\8]{{{{3}}}}l{{{{2}}}}" | {python_command} pwgen2 -c6 {{}} | sort -r',
...
### Comparing `task2b-1.0.7/pyproject.toml` & `task2b-1.0.8/pyproject.toml`
...
### Comparing `task2b-1.0.7/README.md` & `task2b-1.0.8/README.md`

 * *Files identical despite different names*

### Comparing `task2b-1.0.7/PKG-INFO` & `task2b-1.0.8/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: task2b Version: 1.0.7 Summary: Password generation
