# Comparing `tmp/archive-hocr-tools-1.1.50.tar.gz` & `tmp/archive-hocr-tools-1.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "archive-hocr-tools-1.1.50.tar", last modified: Tue Jul 11 11:51:01 2023, max compression
...
## Comparing `archive-hocr-tools-1.1.50.tar` & `archive-hocr-tools-1.1.9.tar`

### file list

```diff
@@ -1,54 +1,34 @@
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.780675 archive-hocr-tools-1.1.50/
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)    34523 2021-06-28 12:40:44.000000 archive-hocr-tools-1.1.50/COPYING
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)    34523 2021-06-28 12:40:44.000000 archive-hocr-tools-1.1.50/LICENSE.txt
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       52 2023-06-30 20:45:00.000000 archive-hocr-tools-1.1.50/MANIFEST.in
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      760 2023-07-11 11:51:01.780675 archive-hocr-tools-1.1.50/PKG-INFO
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      833 2023-06-22 10:00:12.000000 archive-hocr-tools-1.1.50/README
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      833 2023-06-22 10:00:12.000000 archive-hocr-tools-1.1.50/README.rst
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.764009 archive-hocr-tools-1.1.50/archive_hocr_tools.egg-info/
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      760 2023-07-11 11:51:01.000000 archive-hocr-tools-1.1.50/archive_hocr_tools.egg-info/PKG-INFO
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      940 2023-07-11 11:51:01.000000 archive-hocr-tools-1.1.50/archive_hocr_tools.egg-info/SOURCES.txt
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)        1 2023-07-11 11:51:01.000000 archive-hocr-tools-1.1.50/archive_hocr_tools.egg-info/dependency_links.txt
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      196 2023-07-11 11:51:01.000000 archive-hocr-tools-1.1.50/archive_hocr_tools.egg-info/requires.txt
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)        5 2023-07-11 11:51:01.000000 archive-hocr-tools-1.1.50/archive_hocr_tools.egg-info/top_level.txt
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.774009 archive-hocr-tools-1.1.50/bin/
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)    24267 2023-06-22 01:18:04.000000 archive-hocr-tools-1.1.50/bin/abbyy-to-hocr
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     1305 2023-06-28 18:47:13.000000 archive-hocr-tools-1.1.50/bin/fts-text-annotate
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     2196 2023-07-10 20:42:03.000000 archive-hocr-tools-1.1.50/bin/fts-text-match
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     3326 2023-06-22 00:17:27.000000 archive-hocr-tools-1.1.50/bin/hocr-combine-stream
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)    10459 2023-06-22 09:50:52.000000 archive-hocr-tools-1.1.50/bin/hocr-confidence-filter
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     1556 2023-06-22 00:09:17.000000 archive-hocr-tools-1.1.50/bin/hocr-extract-page
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     1411 2023-06-22 00:09:17.000000 archive-hocr-tools-1.1.50/bin/hocr-flatten-pages
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     1814 2023-07-10 20:09:39.000000 archive-hocr-tools-1.1.50/bin/hocr-fold-chars
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     2409 2022-08-12 00:45:40.000000 archive-hocr-tools-1.1.50/bin/hocr-lookup-check
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)      551 2021-01-07 22:43:12.000000 archive-hocr-tools-1.1.50/bin/hocr-lookup-create
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)      888 2021-01-08 12:38:34.000000 archive-hocr-tools-1.1.50/bin/hocr-lookup-reconstruct
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)    36470 2023-07-10 20:46:36.000000 archive-hocr-tools-1.1.50/bin/hocr-pagenumbers
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)     1214 2023-06-22 00:09:17.000000 archive-hocr-tools-1.1.50/bin/hocr-split-pages
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)      594 2021-10-15 21:39:26.000000 archive-hocr-tools-1.1.50/bin/hocr-text
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)      826 2021-01-08 13:40:53.000000 archive-hocr-tools-1.1.50/bin/hocr-text-paragraphs
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)    27998 2023-06-16 20:00:09.000000 archive-hocr-tools-1.1.50/bin/hocr-to-epub
--rwxr-xr-x   0 merlijn   (1000) merlijn   (1000)    13500 2023-06-22 00:09:17.000000 archive-hocr-tools-1.1.50/bin/pdf-to-hocr
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     1552 2023-06-22 09:53:25.000000 archive-hocr-tools-1.1.50/conftest.py
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.774009 archive-hocr-tools-1.1.50/docs/
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      638 2021-10-05 09:04:50.000000 archive-hocr-tools-1.1.50/docs/Makefile
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.774009 archive-hocr-tools-1.1.50/docs/source/
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     1961 2022-04-16 05:05:04.000000 archive-hocr-tools-1.1.50/docs/source/conf.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     4126 2021-10-05 09:04:50.000000 archive-hocr-tools-1.1.50/docs/source/index.rst
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       81 2021-10-05 09:04:50.000000 archive-hocr-tools-1.1.50/docs/source/parse.rst
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       83 2021-10-05 09:04:50.000000 archive-hocr-tools-1.1.50/docs/source/searching.rst
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)      100 2021-10-05 09:04:50.000000 archive-hocr-tools-1.1.50/docs/source/text.rst
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.780675 archive-hocr-tools-1.1.50/hocr/
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       81 2023-06-20 17:49:56.000000 archive-hocr-tools-1.1.50/hocr/__init__.py
-drwxr-xr-x   0 merlijn   (1000) merlijn   (1000)        0 2023-07-11 11:51:01.780675 archive-hocr-tools-1.1.50/hocr/data/
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     6951 2023-01-30 22:06:33.000000 archive-hocr-tools-1.1.50/hocr/data/abbyy-lang-map.csv
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)    11418 2023-07-10 20:40:45.000000 archive-hocr-tools-1.1.50/hocr/fts.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)    11330 2023-06-22 00:14:48.000000 archive-hocr-tools-1.1.50/hocr/parse.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     3925 2023-06-22 00:09:17.000000 archive-hocr-tools-1.1.50/hocr/searching.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     4886 2022-08-12 00:45:40.000000 archive-hocr-tools-1.1.50/hocr/text.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     3791 2023-06-22 00:16:57.000000 archive-hocr-tools-1.1.50/hocr/util.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       23 2023-07-10 20:04:11.000000 archive-hocr-tools-1.1.50/hocr/version.py
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       61 2023-06-16 20:10:53.000000 archive-hocr-tools-1.1.50/pyproject.toml
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)        0 2023-06-22 00:09:17.000000 archive-hocr-tools-1.1.50/requirements.txt
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)       80 2023-07-11 11:51:01.780675 archive-hocr-tools-1.1.50/setup.cfg
--rw-r--r--   0 merlijn   (1000) merlijn   (1000)     1924 2023-06-23 15:18:55.000000 archive-hocr-tools-1.1.50/setup.py
...
### Comparing `archive-hocr-tools-1.1.50/COPYING` & `archive-hocr-tools-1.1.9/COPYING`

 * *Files identical despite different names*

### Comparing `archive-hocr-tools-1.1.50/LICENSE.txt` & `archive-hocr-tools-1.1.9/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `archive-hocr-tools-1.1.50/bin/abbyy-to-hocr` & `archive-hocr-tools-1.1.9/bin/abbyy-to-hocr`
...
### Comparing `archive-hocr-tools-1.1.50/bin/fts-text-annotate` & `archive-hocr-tools-1.1.9/bin/fts-text-annotate`

 * *Files identical despite different names*

### Comparing `archive-hocr-tools-1.1.50/bin/hocr-combine-stream` & `archive-hocr-tools-1.1.9/bin/hocr-combine-stream`
...
### Comparing `archive-hocr-tools-1.1.50/bin/hocr-extract-page` & `archive-hocr-tools-1.1.9/bin/hocr-extract-page`
...
### Comparing `archive-hocr-tools-1.1.50/bin/hocr-flatten-pages` & `archive-hocr-tools-1.1.9/bin/hocr-fold-chars`
...
### Comparing `archive-hocr-tools-1.1.50/bin/hocr-lookup-check` & `archive-hocr-tools-1.1.9/bin/hocr-lookup-check`
...
### Comparing `archive-hocr-tools-1.1.50/bin/hocr-lookup-create` & `archive-hocr-tools-1.1.9/bin/hocr-lookup-create`

 * *Files identical despite different names*

### Comparing `archive-hocr-tools-1.1.50/bin/hocr-lookup-reconstruct` & `archive-hocr-tools-1.1.9/bin/hocr-lookup-reconstruct`

 * *Files identical despite different names*

### Comparing `archive-hocr-tools-1.1.50/bin/hocr-text-paragraphs` & `archive-hocr-tools-1.1.9/bin/hocr-text-paragraphs`

 * *Files identical despite different names*

### Comparing `archive-hocr-tools-1.1.50/hocr/parse.py` & `archive-hocr-tools-1.1.9/hocr/parse.py`
...
### Comparing `archive-hocr-tools-1.1.50/hocr/searching.py` & `archive-hocr-tools-1.1.9/hocr/searching.py`
...
### Comparing `archive-hocr-tools-1.1.50/hocr/text.py` & `archive-hocr-tools-1.1.9/hocr/text.py`
...
### Comparing `archive-hocr-tools-1.1.50/setup.py` & `archive-hocr-tools-1.1.9/setup.py`
