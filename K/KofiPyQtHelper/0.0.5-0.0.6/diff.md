# Comparing `tmp/KofiPyQtHelper-0.0.5.tar.gz` & `tmp/KofiPyQtHelper-0.0.6.tar.gz`
...
## Comparing `KofiPyQtHelper-0.0.5.tar` & `KofiPyQtHelper-0.0.6.tar`
...
### Comparing `KofiPyQtHelper-0.0.5/setup.py` & `KofiPyQtHelper-0.0.6/setup.py`
