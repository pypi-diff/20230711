# Comparing `tmp/yetl-framework-1.6.6.dev4.tar.gz` & `tmp/yetl-framework-1.6.6.dev5.tar.gz`
...
### Comparing `yetl-framework-1.6.6.dev4/yetl/config/table/_read.py` & `yetl-framework-1.6.6.dev5/yetl/config/table/_read.py`
