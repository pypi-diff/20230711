# Comparing `tmp/pqinput-0.0.408.tar.gz` & `tmp/pqinput-0.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pqinput-0.0.408.tar", last modified: Tue Jul 11 09:35:18 2023, max compression
+gzip compressed data, was "pqinput-0.0.5.tar", last modified: Mon Jul  3 16:40:09 2023, max compression
```

## Comparing `pqinput-0.0.408.tar` & `pqinput-0.0.5.tar`

### file list

```diff
@@ -1,16 +1,18 @@
-drwxrwxr-x   0 lubo      (1000) lubo      (1000)        0 2023-07-11 09:35:18.027253 pqinput-0.0.408/
--rw-rw-r--   0 lubo      (1000) lubo      (1000)     1075 2023-02-09 10:07:34.000000 pqinput-0.0.408/LICENSE.txt
--rw-rw-r--   0 lubo      (1000) lubo      (1000)     3887 2023-07-11 09:35:18.027253 pqinput-0.0.408/PKG-INFO
--rw-rw-r--   0 lubo      (1000) lubo      (1000)     3314 2023-05-09 09:41:50.000000 pqinput-0.0.408/README.md
-drwxrwxr-x   0 lubo      (1000) lubo      (1000)        0 2023-07-11 09:35:18.023253 pqinput-0.0.408/pqinput/
--rw-rw-r--   0 lubo      (1000) lubo      (1000)      106 2023-05-09 11:00:00.000000 pqinput-0.0.408/pqinput/__init__.py
--rw-rw-r--   0 lubo      (1000) lubo      (1000)     6695 2023-07-07 15:20:46.000000 pqinput-0.0.408/pqinput/drawPES.py
--rw-rw-r--   0 lubo      (1000) lubo      (1000)    16719 2023-07-11 09:33:25.000000 pqinput-0.0.408/pqinput/inpxml.py
-drwxrwxr-x   0 lubo      (1000) lubo      (1000)        0 2023-07-11 09:35:18.027253 pqinput-0.0.408/pqinput.egg-info/
--rw-rw-r--   0 lubo      (1000) lubo      (1000)     3887 2023-07-11 09:35:18.000000 pqinput-0.0.408/pqinput.egg-info/PKG-INFO
--rw-rw-r--   0 lubo      (1000) lubo      (1000)      226 2023-07-11 09:35:18.000000 pqinput-0.0.408/pqinput.egg-info/SOURCES.txt
--rw-rw-r--   0 lubo      (1000) lubo      (1000)        1 2023-07-11 09:35:18.000000 pqinput-0.0.408/pqinput.egg-info/dependency_links.txt
--rw-rw-r--   0 lubo      (1000) lubo      (1000)        8 2023-07-11 09:35:18.000000 pqinput-0.0.408/pqinput.egg-info/top_level.txt
--rw-rw-r--   0 lubo      (1000) lubo      (1000)      542 2023-07-11 09:34:10.000000 pqinput-0.0.408/pyproject.toml
--rw-rw-r--   0 lubo      (1000) lubo      (1000)       38 2023-07-11 09:35:18.027253 pqinput-0.0.408/setup.cfg
--rw-rw-r--   0 lubo      (1000) lubo      (1000)      653 2023-07-11 09:34:16.000000 pqinput-0.0.408/setup.py
...
### Comparing `pqinput-0.0.408/LICENSE.txt` & `pqinput-0.0.5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `pqinput-0.0.408/PKG-INFO` & `pqinput-0.0.5/PKG-INFO`
...
### Comparing `pqinput-0.0.408/README.md` & `pqinput-0.0.5/README.md`

 * *Files identical despite different names*

### Comparing `pqinput-0.0.408/pqinput/drawPES.py` & `pqinput-0.0.5/pqinput/drawPES.py`
...
### Comparing `pqinput-0.0.408/pqinput/inpxml.py` & `pqinput-0.0.5/pqinput/inpxml.py`
...
### Comparing `pqinput-0.0.408/pqinput.egg-info/PKG-INFO` & `pqinput-0.0.5/pqinput.egg-info/PKG-INFO`
...
### Comparing `pqinput-0.0.408/pyproject.toml` & `pqinput-0.0.5/pyproject.toml`
...
### Comparing `pqinput-0.0.408/setup.py` & `pqinput-0.0.5/setup.py`
